    ...
    def handle(self, *args, **options):
        ...
        models_config = [
            ...
            },
            {
                ...
                'api_endpoint': settings.ANTHROPIC_API_ENDPOINT,
            ...
            },
            {
                ...
                'api_endpoint': settings.DEEPSEEK_API_ENDPOINT,
                'is_active': bool(settings.DEEPSEEK_API_KEY),
                'max_tokens': 2000,
                'temperature': 0.7,
                'supports_english': True,
                'supports_arabic': True,
            ...
            },
            {
                ...
                'api_endpoint': settings.GROK_API_ENDPOINT,
                'is_active': bool(settings.GROK_API_KEY),
                'max_tokens': 2000,
                'temperature': 0.7,
                'supports_english': True,
                'supports_arabic': True,
